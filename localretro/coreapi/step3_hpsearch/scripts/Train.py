...
# NEW - add op to the function header for reporting training progress to master
...
def main(args, core_context):
    ...
    # NEW - pass hparams to load_model
    model, loss_criterion, optimizer, scheduler, stopper = load_model(args, hparams) 
